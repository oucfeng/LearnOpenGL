...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        objectShader.set_uniform("material.ambient", 1.0f, 0.5f, 0.31f);
        objectShader.set_uniform("material.diffuse", 1.0f, 0.5f, 0.31f);
        objectShader.set_uniform("material.specular", 0.5f, 0.5f, 0.5f);
