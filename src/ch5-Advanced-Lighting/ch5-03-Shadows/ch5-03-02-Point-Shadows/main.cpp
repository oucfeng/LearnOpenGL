...
int main()
{
    ...
    depthShader.load_geometry_shader("shaders/depth_geometry.glsl");
    Shader quadShader("shaders/quad_vertex.glsl", "shaders/quad_fragment.glsl");
   ...
   // -------------
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindFramebuffer(GL_FRAMEBUFFER, depthMapFBO);
            ...
            depthShader.use();
            for (GLuint i = 0; i < 6; ++i)
                depthShader.set_uniform("shadowMatrices[" + std::to_string(i) + "]", shadowTransforms[i]);
            depthShader.set_uniform("far_plane", far);
            depthShader.set_uniform("lightPos", lightPos);
        ...
        objectShader.set_uniform("shadows", true);
        objectShader.set_uniform("far_plane", far);
        ...
        objectShader.set_uniform("depthMap", 1);
