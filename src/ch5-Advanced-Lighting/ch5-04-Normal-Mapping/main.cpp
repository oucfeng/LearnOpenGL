...
int main()
{
    ...
    // load textures
   // -------------
    std::string texturePath = "../../../res/textures/brickwall.jpg";
    unsigned int wallTexture = loadTexture(texturePath.c_str());

    std::string normalPath = "../../../res/textures/brickwall_normal.jpg";
