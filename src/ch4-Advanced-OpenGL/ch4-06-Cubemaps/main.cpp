...
int main()
{
    ...
    unsigned int cubeVAO, planeVAO, skyboxVAO;
    ...
    {
        "../../../res/skybox/scenery/right.jpg",
        "../../../res/skybox/scenery/left.jpg",
        "../../../res/skybox/scenery/top.jpg",
        "../../../res/skybox/scenery/bottom.jpg",
        "../../../res/skybox/scenery/front.jpg",
        "../../../res/skybox/scenery/back.jpg"
    };
